...
<nav class="navbar navbar-expand-lg navbar-light">
    <div class="container">
        ...
        <div class="d-flex justify-content-end">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('moving.resident') }}">جابجایی</a>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="{{ route('search.showList') }}">اقامتگران</a></li>
                        <li><a class="dropdown-item" href="{{ route('search.ends.showList') }}">اقامتگران خروجی</a></li>
                    </ul>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('thakts.show') }}">آمار تخت ها</a>
