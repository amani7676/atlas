        ...
        @foreach ($otaghs['takhts'] as $takhts)
            ...
            @else
                <tr data-resident-id="{{ $takhts['resident']['resident_id'] }}">
                    ...
                    <td>
                        <a href="#" class="m-1 save-resident">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                                class="bi bi-play-fill text-success" viewBox="0 0 16 16">
                                <path
                                    d="m11.596 8.697-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308c0-.63.692-1.01 1.233-.696l6.363 3.692a.802.802 0 0 1 0 1.393" />
                            </svg>
                        </a>
                        <a href="#"  class="m-1" data-bs-toggle="offcanvas" data-bs-target="#staticBackdrop" aria-controls="staticBackdrop">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                        ...
                        <a href="#" class="m-1" >
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-brush-fill text-primary" viewBox="0 0 16 16">
