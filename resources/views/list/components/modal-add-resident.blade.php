                                    ...
                                    <div class="form-container">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                <label for="name" class="form-label required-field">نام و نام
                                                    خانوادگی</label>
                                                <input type="text" class="form-control" id="full_name_add"
                                                    name="full_name_add" placeholder="نام کامل را وارد کنید" required>
                                            </div>
                                            <div class="col-md-6">
                                                <label for="phone" class="form-label required-field">تلفن</label>
                                                <input type="tel" class="form-control" id="phone_add"
                                                    name="phone_add" placeholder="شماره تلفن را وارد کنید">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="end_date_add"
                                                    name="end_date_add" required placeholder="1404/1/1">
                                                @error('end_date_add')
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="d-flex flex-wrap gap-3">
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label" for="ejareh_add">اجاره</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            id="vadeh_add" name="vadeh_add" checked>
                                                        <label class="form-check-label" for="vadeh_add">ودیعه</label>
                                                    </div>
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="d-flex flex-wrap gap-3">
                                                    ...
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label" for="madrak_add">مدرک</label>
                                                    </div>
