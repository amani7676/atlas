        ...
        <form id="filter-form" wire:submit.prevent="ShowList">
            <div class="d-flex flex-row">
                ...
                <div class="p-2">
                    ...
                    <input type="text" wire:model.lazy="start_date" class="mt-1 block w-full border rounded px-2 py-1">
                </div>

                <div class="p-2">
                    <label class="block text-sm font-medium">شروع قرارداد تا</label>
                    <input type="text" wire:model.lazy="start_date_ta" class="mt-1 block w-full border rounded px-2 py-1">
                </div>

                <div class="p-2">
                    <label class="block text-sm font-medium">پایان قرارداد از</label>
                    <input type="text" wire:model.lazy="end_date" class="mt-1 block w-full border rounded px-2 py-1">
                </div>

                <div class="p-2">
                    <label class="block text-sm font-medium">پایان قرارداد تا</label>
                    <input type="text" wire:model.lazy="end_date_ta" class="mt-1 block w-full border rounded px-2 py-1">
                </div>
                <!-- عدد -->
                <div class="p-2">
